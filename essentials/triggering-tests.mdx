...
<!-- IMAGE_PLACEHOLDER: Screenshot of the Trigger Run config modal showing test selection -->
...
<!-- IMAGE_PLACEHOLDER: Screenshot of variable mapping UI in the Trigger Run config modal -->
