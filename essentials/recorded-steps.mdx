...
Recorded steps are clicks, hovers, and scrolls that Docket records while you interact with the [remote screen](/essentials/remote-screen) during test creation. Each recorded step stores both **the exact screen coordinates** of your action and a **natural language annotation** that describes what you did.
...
Recorded steps execute **sequentially**, one after another. In [recording mode](/essentials/remote-screen#start-recording), they do not waiting for page loads or self heal. Recorded steps will auto wait for page loads or try to self heal during full test runs (see below). 
