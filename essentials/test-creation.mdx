...
Variables can be created in the Variables tab and inserted into test instructions by pressing `@` while writing.
...
Generate a unique mailbox per test run (e.g., `baseaddress+unique123@domain.com`). The agent can monitor this specific address for incoming emails during test execution.
