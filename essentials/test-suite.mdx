...
You can also schedule all tests in a given test suite to run at some cadence. See the [scheduling section](https://docket-dcd24ade.mintlify.app/essentials/running-test#scheduling-a-run) on the test creation page for instructions on how to set this up.