...
Works across **Web, iOS, and Android**—point any screen or device at `localhost`, a private network, a staging environment, or any service that isn't publicly reachable. If your laptop can hit it, Docket can test it.
