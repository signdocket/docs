...
Cached steps are clicks, hovers, and scrolls that Docket records while you interact with the remote browser in the test creation screen.\
...
![/images/remote_browser_cache_step.png](/images/remote_browser_cache_step.png)
