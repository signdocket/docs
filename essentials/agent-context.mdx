...
If there is certain context that is specific to your application, you can create an agent rule for it. These rules are injected into Docket's system prompt when running your tests to help the agent navigate your application. 
...
Examples of things to create an agent rule might be: 
