          ...
          testParameters: |
            {
              ...
              "test_blueprint_category_url_overrides": {
                "3": "https://bing.com"
              },
              "test_blueprint_url_overrides": {
...
Override starting URLs for tests during CI/CD runs to test against different environments.

**Test Suite Level**: Use `test_blueprint_category_url_overrides` with test suite IDs  
**Individual Test Level**: Use `test_blueprint_url_overrides` with test IDs

```json
{
  "test_blueprint_category_id": ["17"],
  "test_blueprint_category_url_overrides": {
    "17": "https://bing.com"
  },
  "test_blueprint_url_overrides": {
    "167": "https://staging.docketqa.com"
  }
}
```

In this example: all tests in test suite `17` will start at `https://bing.com`, except test `167` which will start at `https://staging.docketqa.com` instead.

Individual test overrides take precedence over test suite overrides. Both are optional.