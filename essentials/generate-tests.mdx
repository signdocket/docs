...
> **Tip**: Generated tests are a starting point. After creation, open individual tests to fine-tune steps, add [cached steps](/essentials/cached-steps), or adjust [variables](/essentials/test-creation#test-variables).
