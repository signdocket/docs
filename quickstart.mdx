...
- Learn about [AI Steps](/essentials/ai-steps) and [Cached Steps](/essentials/cached-steps) to understand how to build effective tests.
...
- [Cached Steps](/essentials/cached-steps) - Understand coordinate-based actions
